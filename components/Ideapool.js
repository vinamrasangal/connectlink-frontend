    ...
    <>
      <section className={styles.ideas}>
        ...
        <div className={styles.explore}>
          ...
          <div className={styles.btns}>
            <button className={`${styles.btn} medium-fs normal normal-gray`}>
              Popular
            </button>
            <button className={`${styles.btn} medium-fs normal normal-gray`}>
              New
          ...
          <button
            className={`${styles.filterBtn} S-BTN`}
            onClick={() => setIsSortShowen((prev) => !prev)}
          >
          ...
          <ul
            className={`${styles.ul} ${
              isSortShowen && styles.showen
            } dark-gray normal medium-fs`}
            role="list"
          >
            <li className={`${styles.li}`}>
              <p className={styles.p}>Top post</p>
              <span className={styles.span}>{AiOutlineCheck({})}</span>
            </li>
            <li className={`${styles.li} ${styles.active}`}>
              <p className={styles.p}>New post</p>
              <span className={styles.span}>{AiOutlineCheck({})}</span>
            </li>
            <li className={`${styles.li}`}>
              <p className={styles.p}>Your post</p>
              <span className={styles.span}>{AiOutlineCheck({})}</span>
            </li>
          </ul>
        </div>
      ...
      <section className={styles.rightSide}>
        <article className={styles.interests}>
          <h2 className={`${styles.h2} large-fs light normal-gray`}>
            Interests
          </h2>
        ...
        <article className={styles.trending}>
          ...
          <ul className={styles.ul} role="list">
            <li className={styles.li}>
              ...
              <p className={`${styles.p} medium-fs normal dark-gray`}>
                Catalog{" "}
              </p>
              <span className={`${styles.span} small-fs light light-gray`}>
